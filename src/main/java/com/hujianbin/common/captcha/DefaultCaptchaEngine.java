...
public class DefaultCaptchaEngine extends ListImageCaptchaEngine{

	public DefaultCaptchaEngine() {
		super();
	...
	protected void buildInitialFactories() {
		 int minWordLength = 4;  
	        ...
	        dictionnaryWords=new RandomWordGenerator("0123456789abcdefghijklmnopqrstuvwxyz");
	        //dictionnaryWords=new ComposeDictionaryWordGenerator(new FileDictionary("sdf"));
