...
public class Complier {
    ...
    public Complier(String javaSourcePath, String javaClassPath, String targetPath) {
    ...
    public static void main(String[] args) throws IOException {
        String currentDir = "D:\\template";
        String javaSourcePath = currentDir + "/org";
        String javaClassPath = currentDir + "/classes/";
        String targetPath = currentDir + "/target/jsoup.jar";

        Complier cl = new Complier(javaSourcePath, javaClassPath, targetPath);
//        cl.complier();
        cl.generateJar();
    }
}
