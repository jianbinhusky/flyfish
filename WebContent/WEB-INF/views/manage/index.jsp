					...
					<div class="box-content">
						...
						<div id="myTabContent" class="tab-content">
							<div class="tab-pane active" id="info">
								...
								<p>Its a fully featured, responsive template for your admin panel. Its optimized for tablet and mobile phones. Scan the QR code below to view it in your mobile device.</p> <img alt="QR Code" class="charisma_qr center" src="<c:url value='/static/charisma-master/img/qrcode136.png' />" />
							</div>
					...
					<div class="box-content">
						<div class="box-content">
							<ul class="dashboard-list">
								<li>
									<a href="#">
										<img class="dashboard-avatar" alt="Usman" src="<c:url value='/static/images/beauty_girl_26.jpg' />"></a>
								...
								<li>
									<a href="#">
										<img class="dashboard-avatar" alt="Sheikh Heera" src="<c:url value='/static/images/beauty_girl_22.jpg' />"></a>
								...
								<li>
									<a href="#">
										<img class="dashboard-avatar" alt="Abdullah" src="<c:url value='/static/images/beauty_girl_222.jpg' />"></a>
								...
								<li>
									<a href="#">
										<img class="dashboard-avatar" alt="Saruar Ahmed" src="<c:url value='/static/images/beauty_girl_52.jpg' />"></a>
