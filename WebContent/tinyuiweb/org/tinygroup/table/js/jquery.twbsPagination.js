        ...
        buildListItems: function (pages) {
            ...
            if (this.options.prev) {
				if(this.options.startPage<=1){
					...
					prevpage=this.options.startPage-1;
				}
                $listItems = $listItems.add(this.buildItem('prev', prevpage));
            }
            ...
            if (this.options.next) {
				if(this.options.startPage>=this.options.totalPages){
					...
					nextpage=this.options.startPage+1;
				}
                $listItems = $listItems.add(this.buildItem('next', nextpage));
            }
