...
(function ($) {
    ...
    $.extend(true, $.trumbowyg, {
        ...
        upload: {
            serverPath: typeof(UPLOAD_ACTION_URL)!="undefined"?UPLOAD_ACTION_URL:(contextPath+"/savepic.umupload"),
            fileFieldName: 'upfile',
            data: [],
            headers: {},
            urlPropertyName: 'url',
            statusPropertyName: 'state',
            success: undefined,
            error: undefined
        },
                                ...
                                $.ajax({
                                    ...
                                    success: $.trumbowyg.upload.success || function (data) {
                                        ...
                                        if (!!getDeep(data, $.trumbowyg.upload.statusPropertyName.split('.'))) {
                                            var url = contextPath+getDeep(data, $.trumbowyg.upload.urlPropertyName.split('.'));
