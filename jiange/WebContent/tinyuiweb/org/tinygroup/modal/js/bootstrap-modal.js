 /* ===========================================================
    ...
    * ========================================================== */
    !function ($) {
        ...
        Modal.prototype = {
            ...
            init: function (element, options) {
                ...
                $(element).delegate('.glyphicon-fullscreen', 'click.dismiss.modal', $.proxy(this.fullScreen, this));
    ...
    /*$(".modal").resize(function(){var modal_h=$(".modal").height();var windows_h=$(window).height();if(modal_h>=windows_h){$(this).addClass("modal-overflow modal-overflow2");return;}
