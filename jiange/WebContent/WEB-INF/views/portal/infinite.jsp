...
<head>
  ...
  <link type="text/css" href="<c:url value="/static/css/base.css" /> " rel="stylesheet" />
...
<body class="demos ">
  ...
  <div id="alert"><a href="http://desandro.com/masonry">Masonry v3 is out! See it at desandro.com/masonry</a></div>
...
<nav id="page-nav">
  <a href="<c:url value="/static/page/pages_2.html" />"></a>
</nav>
		...
		<script type="text/javascript" src="<c:url value='/static/scripts/jquery.infinitescroll.min.js' />"></script>
<script>
  $(function(){
  ...
  <!-- analytics -->
  <script>
    var _gaq=[['_setAccount','UA-592624-3'],['_setDomainName', '.desandro.com'],['_trackPageview'],['_trackPageLoadTime']];
