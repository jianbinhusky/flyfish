package com.hujianbin.common.taglib;
		...
		try {
			if (pageNumber > 0) {
				...
				if("article".equals(theme)){
					...
					if (curPage > 1) {
						if (start > 1) {
							out.print("<li class=\"first-child\"><a href='javascript:search2(1)'>首页</a></li>");
						}
						out.print("<li class=\"first-child\"><a href='javascript:search2(" + (curPage - 1)
								+ ")' id=\"pagination_pre_link\">&lt;</a></li>");
					}
					...
					for (int i = start; i <= end; i++) {
						if (i == curPage) {
							...
							out.print("<li class=''><a href='javascript:search2(" + i + ")'>" + i
									+ "</a></li>");
						}
					}
					if (curPage < totalPage) {
						out.print("<li class=\"last-child\"><a href='javascript:search2(" + (curPage + 1)
								+ ")' id=\"pagination_next_link\">&gt;</a></li>");
						if (end < totalPage) {
							out.print("<li><a href='javascript:search2(" + totalPage
									+ ")'>尾页</a></li>");
						}
					}
