/* $Id: DecryptAndVerify.java,v 1.2 2005/03/13 17:46:35 woudt Exp $
 *
...
/**
 * Detailed example for decrypting and verifying a message. It understands 
 * signed-only, encrypted-only and encrypted-and-signed messages.
 *
 * Assumes that the GenerateAndWriteKey and EncryptAndSign examples has been 
 * run, although it also understands the output of the Encrypt and ClearSign
 * examples.
 *
...
public class DecryptAndVerify {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            FileInputStream in = new FileInputStream("encrypted-signed.asc");
