/* $Id: LegacyEncryptAndSign.java,v 1.1 2005/03/13 17:12:58 woudt Exp $
 *
...
/**
 * Detailed example for encrypting and signing a message using legacy keys.
 * This example assumes that the LegacyGenerateKey example has been run first.
 *
 * @author  Edwin Woudt <edwin@cryptix.org>
 * @version $Revision: 1.1 $
 */
public class LegacyEncryptAndSign {
    ...
    public static void main (String[] args) {
        ...
        try {
            ...
            EncryptedMessageBuilder emb = 
                EncryptedMessageBuilder.getInstance("OpenPGP/Legacy");
            emb.init(msg);
